...
type FileCachingProducer[TMessage any] struct {
	mu       sync.Mutex
	messages []TMessage
...
func NewFileCachingProducer[TMessage any](key string, logger log.Logger, producer Producer[TMessage]) *FileCachingProducer[TMessage] {
	return &FileCachingProducer[TMessage]{
...
func (p *FileCachingProducer[TMessage]) Produce(ctx context.Context, messages ...TMessage) error {
...
func (p *FileCachingProducer[TMessage]) Send(ctx context.Context) error {
